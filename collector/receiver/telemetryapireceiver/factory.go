...
func createTracesReceiver(ctx context.Context, params component.ReceiverCreateSettings, rConf component.ReceiverConfig, next consumer.Traces) (component.TracesReceiver, error) {
	cfg, ok := rConf.(*Config)
	if !ok {
